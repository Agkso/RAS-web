...
import { LogOut, Plus, FileText, MapPin, History } from 'lucide-react';
import { denunciaService } from '../services/denunciaService';
import { Denuncia } from '../types';
import HistoricoDenuncias from '../components/HistoricoDenuncias';
  ...
  useEffect(() => {
    const fetchMinhasDenuncias = async () => {
      ...
      try {
        ...
        const response = await denunciaService.listarMinhasDenuncias('page=0&size=5');
              ...
              <div className="bg-white shadow overflow-hidden sm:rounded-md">
                <div className="px-4 py-5 sm:px-6">
                  ...
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">
                    Últimas 5 denúncias enviadas por você
                  </p>
                </div>
