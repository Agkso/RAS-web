...
import { LogOut, FileText, Filter, CheckCircle, XCircle } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  >
                    ...
                    <option value="A_CAMINHO_VISTORIA">A Caminho da Vistoria</option>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-md">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Lista de denúncias que requerem sua atenção
              </p>
            </div>
            <div className="border-t border-gray-200">
              <div className="px-4 py-5 sm:p-6">
                <p className="text-gray-500 text-center">
                  Nenhuma denúncia encontrada para análise.
                </p>
              </div>
            </div>
          </div>
